...
static struct gpiomux_setting cyts_sleep_sus_cfg2 = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct gpiomux_setting ap2mdm_cfg2 = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct msm_gpiomux_config msm8960_cyts_configs[] __initdata = {
	...
	{	/* TS SLEEP */
		...
		.settings = {
			...
			[GPIOMUX_SUSPENDED] = &cyts_sleep_sus_cfg2,
		},
	},
	{	/* TS RESOUT */
		.gpio = 52,
